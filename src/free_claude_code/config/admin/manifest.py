...
SECTIONS: tuple[ConfigSectionSpec, ...] = (
    ...
    ConfigSectionSpec(
        "user_models",
        "User Models",
        "Custom model references beyond discovered provider models.",
    ),
    ConfigSectionSpec(
        "web_tools",
        "Web Tools",
...
_NON_PROVIDER_FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        default="true",
        description="Open the Admin UI after the next pcc-server launch becomes healthy.",
    ),
    ConfigFieldSpec(
        "MESSAGING_PLATFORM",
        "Messaging Platform",
    ...
    ConfigFieldSpec(
        ...
        "model_refs",
        description=(
            "One provider/model per line. These models become available in the "
            "model routing comboboxes above and in provider model lists."
        ),
    ),
    ConfigFieldSpec(
