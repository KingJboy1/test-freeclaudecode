...
class Settings(BaseSettings):
    ...
    # User-defined model refs (newline-separated, e.g. "open_router/anthropic/claude-sonnet-4\nsambanova/...").
    # These appear as extra options in the model-combobox dropdown alongside
    # provider-discovered models and the per-route overrides above.
    chat_model_refs: str = Field(default="", validation_alias="CHAT_MODEL_REFS")
